...
local PROGRAM_NAME = 'sordfd5.rom'
...
local regmaps = {
	...
	z80 = {
		togdb = {
			SP = 1, AF = 10, BC = 11, DE = 12, HL = 13, IX = 14, IY = 15, AF2 = 16, BC2 = 17, DE2 = 18, HL2 = 19, R = 20, I = 21, IM = 22,
			IFF1 = 23, IFF2 = 24, HALT = 25, WZ = 30},
		fromgdb = {
			"SP","AF","BC","DE","HL","IX","IY","AF2","BC2","DE2","HL2","R","I","IM","IFF1","IFF2","HALT","WZ"},
		regsize = 2,
		addrsize = 2,
		pcreg = "PC"
		},
...
function gdbstub.startplugin()
	...
	reset_subscription = emu.add_machine_reset_notifier(function ()
		...
		cpu = manager.machine.devices[":z80fd5"] -- :maincpu"]
		if not cpu then
